...
//
//        assertEquals("first-value", ss.toObject(sessionState.attributes.get("first-key")));
//        assertEquals("second-value", ss.toObject(sessionState.attributes.get("second-key")));
//
...
//    }
    ...
    public void testIssue3132() throws Exception {
        CookieStore cookieStore = new BasicCookieStore();
        System.out.println("calling " + serverPort1);
        ...
        Thread.sleep(1000);
        System.out.println("calling " + serverPort2);
